...
(async () => {
  ...
  for (const width of [640,680,700,720,750,768,800,850,900,950,1000,1024,1100,1200]) {
    ...
    console.log(width, 'h1lines', lines, 'headerH', headerBox.height, 'wrapY', wrapBox.y, 'holoY', holoBox.y, 'OVERLAP', overlap);
    await page.close();
  }
  await browser.close();
})();
